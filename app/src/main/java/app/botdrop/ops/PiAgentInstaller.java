...
public class PiAgentInstaller {
    ...
    private CommandResult runCommand(String command, int timeoutSeconds) {
        ...
        try {
            ...
            tmpOutput = new File(tmpDir, "pi_install_" + System.currentTimeMillis() + ".out");
            ...
            if (!finished) {
                ...
                return new CommandResult(false, readOutput(tmpOutput),
            ...
            return new CommandResult(false, stdout, "Exception: " + e.getMessage(), exitCode);
        } finally {
